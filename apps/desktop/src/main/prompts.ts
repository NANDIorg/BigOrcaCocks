...
import assistantSkill from '../../../../skills/assistant.md?raw'

/** Служебные инструкции Orca: их получают агенты при запуске (worker.ts) и их же показывает UI ролей. */
export const BUILTIN_PROMPTS: BuiltinPrompts = { worker: workerSkill, coordinator: coordinatorSkill, assistant: assistantSkill }
