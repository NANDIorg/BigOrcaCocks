 ...
 * «Ждут вас» и доской, Alt+1…5 (и 1…5 вне доски) — вкладки экрана. Решение «наша ли это клавиша» — здесь, чистой функцией: один обработчик на экран, а не
...
/** Число вкладок экрана, на которые есть цифра (1–5). */
export const TAB_HOTKEYS = 5

/**
 * Номер вкладки (с 0) по клавише или `undefined`. Alt+1…5 работает везде, кроме полей ввода и модалок; голые 1…5 —
